...
namespace WebApiLoL.Entidades
{
    public class clsPersonaje
    {
        ...
        public clsPersonaje(string nombre, string alias, double vida, double regeneracion, double danno, double armadura, double velAtaque, double resistencia, double velMovimiento,int idCategoria)
        {
            this.nombre = nombre;
            this.alias = alias;
            this.vida = vida;
